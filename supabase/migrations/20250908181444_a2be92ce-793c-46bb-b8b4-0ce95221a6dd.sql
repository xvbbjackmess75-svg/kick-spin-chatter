-- Drop the existing function and recreate it with usernames and financial data
DROP FUNCTION IF EXISTS public.get_overlay_slots_calls();

-- Create the updated function that includes usernames and financial data for overlay display
